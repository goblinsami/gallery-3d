...
export const DEFAULT_GALLERY_CONFIG: ArtGallerySceneConfig = {
  ...
  ceilingSpotsIntensity: 1.55,
  ceilingLightIntensity: GALLERY_DEFAULTS.architecture.ceilingFillLightIntensity,
  lightGridWidth: GALLERY_DEFAULTS.architecture.lightGridWidth,
  lightGridRailWidth: GALLERY_DEFAULTS.architecture.ceilingGridRailWidth,
  artworkBacklightEnabled: true,
  artworkBacklightColor: GALLERY_TOKENS.scene.defaultArtworkBacklightColor,
  artworkBacklightIntensity: 0.24,
  artworkDirectionalKeyLightEnabled: false,
  artworkDirectionalKeyLightColor: "#ffffff",
  artworkDirectionalKeyLightIntensity: 0.9,
